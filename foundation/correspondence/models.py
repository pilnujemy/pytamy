...
class Letter(models.Model):
    ...
    contact = models.ForeignKey(to=Contact,
                                verbose_name=_("Contact"))
    transfer_on = models.DateField(verbose_name=_("Transfer on"),
...
class Attachment(models.Model):
    letter = models.ForeignKey(to=Letter,
                               verbose_name=_("Letter"))
    file = models.FileField(verbose_name=("File"),
                            upload_to="correspondence_attachment")
    protected = models.BooleanField(default=False,
                                    verbose_name=_("Content protected"),
                                    help_text=_("Unmark if safe for the rights of third parties"))
